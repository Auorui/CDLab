...
import warnings
import math
from models.baseline.changeformer.base_module import ResidualBlock, UpsampleConvLayer, ConvLayer
...
class ChangeFormerV1(nn.Module):
    ...
    def __init__(self, input_nc=3, num_classes=2, decoder_softmax=False):
        ...
        self.change_probability = ConvLayer(8, num_classes, kernel_size=3, stride=1, padding=1)
...
class ChangeFormerV2(nn.Module):
    ...
    def __init__(self, input_nc=3, num_classes=2, decoder_softmax=False):
        ...
        self.TDec = TDec(input_transform='multiple_select', in_index=[0, 1, 2, 3], align_corners=True,
                         in_channels=[64, 128, 320, 512], embedding_dim=32, output_nc=num_classes,
...
class ChangeFormerV3(nn.Module):
    ...
    def __init__(self, input_nc=3, num_classes=2, decoder_softmax=False):
        ...
        self.TDec = TDecV2(input_transform='multiple_select', in_index=[0, 1, 2, 3], align_corners=True,
                           in_channels=[64, 128, 320, 512], embedding_dim=64, output_nc=num_classes,
                           decoder_softmax=decoder_softmax, feature_strides=[4, 8, 16, 32])
...
class ChangeFormerV4(nn.Module):
    ...
    def __init__(self, input_nc=3, num_classes=2, decoder_softmax=False):
        ...
        self.Tenc_x2 = EncoderTransformer_x2(img_size=256, patch_size=3, in_chans=input_nc, num_classes=num_classes,
        ...
        self.TDec_x2 = DecoderTransformer_x2(input_transform='multiple_select', in_index=[0, 1, 2, 3, 4],
                                             align_corners=True,
                                             in_channels=self.embed_dims, embedding_dim=256, output_nc=num_classes,
...
class ChangeFormerV5(nn.Module):
    ...
    def __init__(self, input_nc=3, num_classes=2, decoder_softmax=False, embed_dim=256):
        ...
        self.Tenc_x2 = EncoderTransformer_v3(img_size=256, patch_size=4, in_chans=input_nc, num_classes=num_classes,
                                             embed_dims=self.embed_dims,
...
class ChangeFormerV6(nn.Module):
    def __init__(self, input_nc=3, num_classes=2, decoder_softmax=False, embed_dim=256):
        ...
        self.Tenc_x2 = EncoderTransformer_v3(img_size=256, patch_size=7, in_chans=input_nc, num_classes=num_classes,
                                             embed_dims=self.embed_dims,
...
if __name__=="__main__":
    ...
    img1 = torch.randn(batch_size, 3, img_size, img_size).to(device)
    img2 = torch.randn(batch_size, 3, img_size, img_size).to(device)
    with torch.no_grad():
        out = model(img1, img2)
