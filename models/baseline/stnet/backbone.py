...
def build_resnet_backbone(backbone, pretrained=True):
    if backbone == 'resnet18':
        model = get_resnet18(pretrained)
    elif backbone == 'resnet50_os8':
        model = get_resnet50_OS8(pretrained)
    elif backbone == 'resnet50_os32':
        model = get_resnet50_OS32(pretrained)
    else:
...
if __name__ == "__main__":
    model = build_resnet_backbone('resnet18')
