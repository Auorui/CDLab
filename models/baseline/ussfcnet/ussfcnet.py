...
from models.baseline.ussfcnet.blocks import MSDConv_SSFC
...
class USSFCNet(nn.Module):
    def __init__(self, in_ch, num_classes, ratio=0.5):
        ...
        self.Conv_1x1 = nn.Conv2d(int(64 * ratio), num_classes, kernel_size=1, stride=1, padding=0)
