...
from models.baseline.dpccnet.backbone import resnet50_3layers
from models.baseline.dpccnet.dpf import DPF
from models.baseline.dpccnet.ccm import CCM


class DPCCNet(nn.Module):
    def __init__(self, fuse_out_channels=256, ocr_in_channels=768, ocr_mid_channels=256, ocr_key_channels=128, num_classes=2, pretrained=True):
        ...
        self.OCR = CCM(in_channels= ocr_in_channels, mid_channels= ocr_mid_channels, key_channels=ocr_key_channels, num_classes=num_classes)
        ...
        self.head = nn.Sequential(
            ...
            nn.Conv2d(ocr_mid_channels, num_classes,
